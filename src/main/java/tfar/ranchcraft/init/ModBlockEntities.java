...
import tfar.ranchcraft.blockentity.*;

public class ModBlockEntities {

	public static TileEntityType<?> ANGLER;
	public static TileEntityType<?> CAST_IRON_STOVE;
	...
	public static void register(RegistryEvent.Register<TileEntityType<?>> event) {
		...
		CAST_IRON_STOVE = RegisterHelper.register(TileEntityType.Builder.create(CastIronStoveBlockEntity::new,ModBlocks.CAST_IRON_STOVE).build(null),"cast_iron_stove", event.getRegistry());
